...
description = 'A technical guide on architecting 2D simulations using HTML5 Canvas, focusing on frame-rate optimization, object encapsu'
+++
...
```html
<canvas id="gameCanvas" width="640" height="480" style="display: block; margin: 0 auto; background-color: #050505;"></canvas>
```
...
class Entity {
    ...
    update(keys, canvasWidth, canvasHeight) {
        ...
        if (keys["ArrowDown"] && this.y + this.height < canvasHeight) this.y += this.speed;
    }
}
