...
Collision detection determines when objects in a game world interact, enabling realistic and intuitive gameplay. This article surveys key algorithms and techniques for 2D collision detection, detailing their advantages, disadvantages, and implementation considerations.
...
*   **Separating Axis Theorem (SAT):**
    *   **Principle:** Two convex shapes do *not* intersect if there exists at least one axis onto which their projections do not overlap.
    *   **Application:** Tests axes perpendicular to the edges of the polygons. If projections overlap on *all* tested axes, the shapes collide.
